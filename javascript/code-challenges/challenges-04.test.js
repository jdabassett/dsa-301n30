...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  let returnArray = arr.map(item => callback(item));
  return returnArray;
};
...
const sortPeople = (arr) => {
  // Solution code here...
  return arr.sort((a,b)=> a.lastName.toLowerCase().localeCompare(b.lastName.toLowerCase()));
};
...
const sortMeetingsByDay = (arr) => {
  return arr.sort((a,b)=> {return sorter[a.dayOfWeek.toLowerCase()]-sorter[b.dayOfWeek.toLowerCase()]});
};
