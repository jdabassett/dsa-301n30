...
//   // Solution code here...
//   let newArray = arr.map((item)=> item.purchasePrice);
//   return newArray.reduce((a,b)=> {return a+b},0);
// };
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((a,b)=> {a.push(b.name); return a;},[]);
};
...
const reversedString = (str) => {
  // Solution code here...
  return [...str].reduce((a,b)=>{a.unshift(b); return a;},[]).join("");
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let parentArray = arr.filter(item => (item.hasOwnProperty('children') && item.children !== null));
  return parentArray.reduce((a,b)=> {return a+b.children.length},0);
...
const calculateAverage = (arr) => {
  // Solution code here...
  let returnObject = arr.reduce((a,b)=>{a.count++; a.sum+=b; return a;},{count:0,sum:0});
  let returnValue = (returnObject.count!==0)?(returnObject.sum/returnObject.count):'error: zero in denominator';
  return returnValue;
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  return arr.reduce((a,b)=> {return a+=isPrime(b)},0);
};
...
const extractStats = (snorlaxData) => {
  // Solution code here...
  return snorlaxData.stats.reduce((a,b)=>{a[`${b.stat.name}`]=b.baseStat; return a;},{});
};
...
const extractChildren = (arr) => {
  ...
  return filteredArray.reduce((a,b)=>{a.push.apply(a,b.children); return a;},[]);
};
