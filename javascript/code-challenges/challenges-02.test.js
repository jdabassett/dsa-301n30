...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let returnArray = [];
  arr.forEach(item => returnArray.push(2**item))
  return returnArray;
};
...
const charCode = (arr) => {
  // Solution code here...
  let string0 = arr.join("")
  return arr.map((item,index)=> string0.charCodeAt(index));
};
...
const evenOdd = (arr) => {
  // Solution code here...
  return arr.map(item => numToString(item))
};
