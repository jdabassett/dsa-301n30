...
const addOne = (arr) => {
  // Solution code here...
  const returnArr = [];
  arr.forEach((item)=> returnArr.push(item+1));
  return returnArr;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  const returnArr = [];
  arr.forEach((item)=> returnArr.push(item.toUpperCase()));
  return returnArr;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  const returnArr = [];
  words.forEach(item => returnArr.push(callback(item)));
  return returnArr;
};
...
const createList = (availableItems) => {
  // Solution code here...
  let returnArray = [];
  availableItems.forEach(item=>((item.available===true)?(returnArray.push(item.name)):null ));
  return returnArray;
};
...
function switchFunction(value){
  switch (true){
    case (value%5===0 && value%3===0): return 'Fizz Buzz';
    case (value%5===0): return 'Buzz';
    case (value%3===0): return 'Fizz';
...
const fizzbuzz = (arr) => {
  // Solution code here...
  let returnArray = [];
  arr.forEach(item=>returnArray.push(switchFunction(item)));
  return returnArray;
};
